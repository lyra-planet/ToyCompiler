...
class IfExpression extends Expression {
    constructor(props) {
        ...
        var s = "if expression width condition: " +
...
class CompilerParser {
    ...
    initPrecedencesMap() {
        ...
        this.precedencesMap[this.lexer.LT] = this.LESS_GREATER
        this.precedencesMap[this.lexer.GT] = this.LESS_GREATER
    ...
    parseExpression(precedence) {
        ...
        while (this.peekTokenIs(this.lexer.SEMICOLON) !== true && this.peekTokenIs(this.lexer.EOF) !== true && precedence < this.peekPrecedence()) {
